...
const DefaultDashboardTemplate = `{{define "counter_gauge_cumulative"}}
{
  ...
  "spaceLength": 10,
  "stack": false,
  "targets": [{"expr": "{{ .AggregationFunc }}({{ .FullMetricName }}){{ .MetricLabels }}", "intervalFactor": 1, "refId": "A"}],
  "thresholds": [],
  "timeFrom": null,
  "timeRegions": [],
  "timeShift": null,
...
{{define "counter_gauge_rate"}}
{
  ...
  "spaceLength": 10,
  "stack": false,
  "targets": [{"expr": "{{ .AggregationFunc }}(rate({{ .FullMetricName }}[15m])){{ .MetricLabels }}", "intervalFactor": 1, "refId": "A"}],
  "thresholds": [],
  "timeFrom": null,
  "timeRegions": [],
  "timeShift": null,
